...
func (m *MockInteractor) DeleteUser(id string) error {
	m.ctrl.T.Helper()
...
func (mr *MockInteractorMockRecorder) DeleteUser(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUser", reflect.TypeOf((*MockInteractor)(nil).DeleteUser), id)
}

// UpdateUser mocks base method.
func (m *MockInteractor) UpdateUser(user entity.User, id string) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockInteractorMockRecorder) UpdateUser(user, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUser", reflect.TypeOf((*MockInteractor)(nil).UpdateUser), user, id)
}
